 ...
 * `settings::BlockDescriptor` and checks the block's optional callback signatures. All behavior
 ...
 *
 * The list is an optimization, not a contract: a member of an unlisted type instantiates its
